                        ...
                        content={() => {
                            return (
                                <View className={`flex gap-3 `}>
                                    <Text
                                        className={`${getColors.getThemeString('text-dark-standard-text', appTheme)}`}>Latest release:</Text>
                                    <Text
                                        className={`text-2xl ${getColors.getThemeString('text-dark-standard-text', appTheme)}`}>2 HOURS AGO</Text>
                                    <Text
                                        className={`${getColors.getThemeString('text-dark-standard-text', appTheme)}`}>Source</Text>
                                </View>
                            );
                        }}/>
                        ...
                        <GeneralCard
                            ...
                            content={() => (
                                <View className="flex gap-2 content-center justify-center items-center">
                                    ...
                                    <Text
                                        className={`${getColors.getThemeString('text-dark-standard-text', appTheme)}`}>RELEASED</Text>
                                    <Text
                                        className={`text-2xl ${getColors.getThemeString('text-dark-standard-text', appTheme)}`}>2003</Text>
                                </View>
                            )}/>
