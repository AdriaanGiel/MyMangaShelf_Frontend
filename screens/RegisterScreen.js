    ...
    return (
        <KeyboardAvoidingView
            ...
            <View
                ...
                <Text
                    className={`self-center text-4xl py-2 ${getColors.getThemeString('text-dark-standard-text', appTheme)}`}>Register</Text>
                ...
                <Pressable
                    ...
                    <Text
                        className={`text-3xl rounded-xl px-2 py-2 ${getColors.getThemeString('text-dark-standard-text', appTheme)}`}>Register</Text>
                </Pressable>
