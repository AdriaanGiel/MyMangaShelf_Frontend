  ...
  return (
    <View className="mx-auto flex gap-4 w-11/12">
      ...
      <View className="flex flex-row py-5 border-b-2 border-b-stone-500 justify-between">
        <Text className={`text-4xl ${getColors.getThemeString('text-dark-standard-text',appTheme)}`}>Chapters</Text>
        <Text className={`align-bottom  ${getColors.getThemeString('text-dark-standard-text',appTheme)}`}>Total</Text>
      </View>
