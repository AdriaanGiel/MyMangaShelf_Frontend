  ...
  return (
    <View
      ...
      <View className="flex flex-row w-100%  justify-between">
        ...
        <Text
          className={`text-2xl  ${getColors.getThemeString("text-dark-active-text", appTheme)}`}>
          82%
        </Text>
      </View>
      ...
      <View className="w-100% h-5">
        <View
          className={`w-[45%] h-4 ${getColors.getThemeString("bg-dark-greon", appTheme)}`}></View>
      </View>
      ...
      <View className="flex flex-row justify-between gap-4">
        <View
          className={`flex gap-2 content-center rounded-2xl w-1/2 p-5 ${getColors.getThemeString("bg-dark-background", appTheme)}`}>
        ...
        <View
          ...
          <Text
            className={`text-3xl ${getColors.getThemeString("text-dark-standard-text", appTheme)}`}>
            4.1
          </Text>
        </View>
      </View>
