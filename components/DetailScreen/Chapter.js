          ...
          <View className="flex flex-row justify-between">
            <Pressable>
              <View className="flex gap-2">
                <Text className={`${getColors.getThemeString('text-dark-active-text',appTheme)}`}>{ chapter.release_date }</Text>
                <Text className={`text-xl ${getColors.getThemeString('text-dark-standard-text',appTheme)}`}>Chapter: { chapter.name } </Text>
              </View>
